  ...
  render() {
    return (
      <Form>
        ...
        <Form.Field label="Major" control="select">
          <option value="male">Enginner</option>
          <option value="female">Sceience</option>
        </Form.Field>
        <Form.Field label="Education Level" control="select">
          <option value="male">Master</option>
          <option value="female">Bachloree</option>
        </Form.Field>
        <Form.Field>
          <label>CV</label>
        ...
        <Form.Field label="Tags" control="select">
          ...
          <option value="female">Account</option>
        </Form.Field>
